...
export function CourseRowAlternating({
  ...
  return (
    ...
    >
        ...
        >
          ...
          <div className="flex justify-center order-1">
            <div className="relative group">
              ...
              <div className="relative w-[300px] md:w-[380px] h-[225px] md:h-[285px] overflow-hidden">
                ...
                {/* Corner cutout */}
                <div
                  className={`absolute top-0 left-0 w-0 h-0 border-t-[40px] border-r-[40px] border-r-transparent ${
                    isDark ? "border-t-navy" : "border-t-paper"
                  }`}
                />
          ...
          <div className="flex flex-col justify-center text-center md:text-right order-2">
            ...
            <div className="flex items-center gap-3 mb-4 justify-center md:justify-start">
              ...
              <div
                className={`w-8 h-px ${isDark ? "bg-gold/50" : "bg-navy/30"}`}
              />
            ...
            <div className="flex justify-center md:justify-start">
              <Link href={href} className="group">
                <div
                  className={`relative inline-flex items-center gap-3 px-8 py-4 font-bold text-sm transition-all duration-300 ${
                    isDark
                ...
                >
                  ...
                  {/* Corner accent */}
                  <div
                    className={`absolute top-0 left-0 w-0 h-0 border-t-[12px] border-r-[12px] border-r-transparent ${
                      isDark ? "border-t-navy/20" : "border-t-gold"
                    }`}
                  />
                </div>
              </Link>
      ...
      <div
        className={`absolute bottom-6 right-6 w-px h-12 bg-gradient-to-t to-transparent ${
          isDark ? "from-gold/40" : "from-navy/20"
        }`}
      />
      <div
        className={`absolute bottom-6 right-6 h-px w-12 bg-gradient-to-l to-transparent ${
          isDark ? "from-gold/40" : "from-navy/20"
        }`}
      />
    </section>
