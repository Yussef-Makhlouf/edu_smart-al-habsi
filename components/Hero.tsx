    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="container relative z-20 px-6 text-center">
                ...
                >
                    منصة محمد الحبسي التعليمية ليست مجرد دورات، بل رحلة تحول كاملة لقادة الأعمال ورواد المستقبل. اكتشف استراتيجيات النجاح الحقيقية.
                </motion.p>
                ...
                >
                    <Link href="/courses">
                        <Button variant="gold" size="lg" shape="sharp" className="min-w-[200px] text-navy font-bold">
                            تصفح الدورات
                        </Button>
                    </Link>
                    <Button variant="outline" size="lg" shape="sharp" className="text-white border-white/20 hover:bg-white/10">
