...
import { addCourse } from "@/lib/redux/slices/coursesSlice";
...
export function DashboardCourses() {
  ...
  // Use store courses or fallback to mock
  const courses = storeCourses.length > 0 ? storeCourses : MOCK_COURSES;
        ...
        <div className="bg-white p-6 rounded-xl border border-gold/30 shadow-sm mb-6 max-w-3xl">
          ...
          <form onSubmit={handleAddCourse} className="space-y-6">
              ...
              <div className="flex flex-col items-center gap-2 text-gray-500">
                {videoFile ? (
                  ...
                  <>
                    ...
                    <p className="text-xs">
                      أو انقر للاختيار من جهازك (MP4, WebM)
                    </p>
                  </>
                )}
              </div>
            ...
            <div className="flex justify-end gap-2 pt-4 border-t border-gray-100">
              ...
              <Button type="submit" className="bg-gold text-navy font-bold">
                نشر الدورة
              </Button>
            </div>
          </form>
