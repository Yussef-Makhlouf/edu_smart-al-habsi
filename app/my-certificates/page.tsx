    ...
    >
      ...
      <div className="container mx-auto px-6 py-12 flex flex-col lg:flex-row-reverse gap-8 items-start relative z-20">
        ...
        <div className="flex-1 w-full order-2 lg:order-1 space-y-8">
          {/* Stats Summary */}
          {isAuthLoading ? (
            <Skeleton className="h-24 w-64 bg-white border border-gray-100" />
          ) : (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
            {isAuthLoading
              ? [1, 2].map((i) => (
                  <div
                    key={i}
                    className="bg-white rounded-xl border border-gray-100 overflow-hidden p-6 space-y-4"
                  >
